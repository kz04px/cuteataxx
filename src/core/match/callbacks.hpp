...
struct Callbacks {
    ...
    std::function<void(const std::string &, const std::string &, const std::string &)> on_game_started =
        [](auto, auto, auto) {
        };
    std::function<void(const libataxx::Result, const std::string &, const std::string &)> on_game_finished =
        [](auto, auto, auto) {
        };
